...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul class="four steps steps1">
                    ...
                    <li class="complete"><a href="#">2</a><br><span class="stepstext">{!! trans('home.CHOOSE_BIKE') !!}</span></li>
    ...
    <div class="container">
        {!! Form::open(['method' => 'POST', 'action' => 'RentalBikesController@store','id'=>'final-step-form', 'files'=>true]) !!}
            ...
            <div class="col-md-6 car_details">
                ...
                @foreach($bikes as $bike)
                    @if($bike->id == $bike_id)
                        ...
                        <h1 class="car-name">{{$bike->type}} {{$bike->name}}</h1>
                        <p class="days"> {!! trans('home.Rent_for') !!} <strong>{{$days}}</strong> {!! trans('home.Day_s') !!} <strong class="pull-right">{{$days * $bike->price_per_day}} $</strong></p>
                        <br>
                        <br>
